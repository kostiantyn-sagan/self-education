...
function Developer() {
  this.completedTasks = []; // устанавливаю свойство completedTasks внутри функции конструктора,
  //при создании экземпляра свойство completedTasks будет создано для каждого экземпляра своё
}

// Developer.prototype.completedTasks = []; // убираю свойство completedTasks с прототипа
